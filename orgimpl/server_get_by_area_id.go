...
func (s *server) GetByAreaId(ctx context.Context, req *pbOrg.GetByAreaIdRequest) (res *pbOrg.GetResponse, err error) {
	...
	id, err := primitive.ObjectIDFromHex(req.GetAreaId())
	if err != nil {
